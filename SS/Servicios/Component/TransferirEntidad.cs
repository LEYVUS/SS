...
using SSUABC.Servicios.Component;
using System;
...
namespace SSUABC.Servicios.Component
{
    public static class TransferirEntidad
    {
        ...
        {
            Solicitud solicitud = new Solicitud(new Actividad(), new Estado(), new Evento(),new Recurso()
                , new Validacion());
            ...
            solicitud.Recurso.Descripcion_Otro = solicitudDTO.Recurso_Solicitado.Descripcion_Otro;
