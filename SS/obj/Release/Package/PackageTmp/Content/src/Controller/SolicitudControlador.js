appController.controller("solicitudCtrl", ['$scope', '$location', '$rootScope', '$http', 'ModalService', 'servicioURL', 'tokenServicio', '$routeParams', function ($scope, $location, $rootScope, $http, ModalService, servicioURL, tokenServicio, $routeParams) {
