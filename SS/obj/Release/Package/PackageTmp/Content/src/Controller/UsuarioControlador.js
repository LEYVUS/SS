appController.controller("usuarioCtrl", ['$scope', '$location', '$rootScope', '$http', 'ModalService', 'servicioURL', 'tokenServicio', function ($scope, $location, $rootScope, $http, ModalService, servicioURL, tokenServicio) {
...
appController.controller('ModalController', ['$scope', 'close', 'mensaje', function ($scope, close, mensaje) {
...
appController.controller('EditarController', ['$scope', '$rootScope', 'close', 'carrera', 'usuario', function ($scope, $rootScope, close, carrera, usuario) {
...
appController.controller('BorrarController', ['$scope', 'close', function ($scope, close) {
